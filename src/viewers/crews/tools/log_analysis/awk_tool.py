...
# Example:
# class AwkToolToolInput(BaseModel):
...
class AwkToolTool(BaseTool):
    name: str = "AwkToolTool"
    description: str = "Description for AwkToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = AwkToolToolInput # Uncomment if Input Schema is defined
