...
# Example:
# class RegexToolToolInput(BaseModel):
...
class RegexToolTool(BaseTool):
    name: str = "RegexToolTool"
    description: str = "Description for RegexToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = RegexToolToolInput # Uncomment if Input Schema is defined
