...
# Example:
# class SedToolToolInput(BaseModel):
...
class SedToolTool(BaseTool):
    name: str = "SedToolTool"
    description: str = "Description for SedToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = SedToolToolInput # Uncomment if Input Schema is defined
