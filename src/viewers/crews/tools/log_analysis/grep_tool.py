...
# Example:
# class GrepToolToolInput(BaseModel):
...
class GrepToolTool(BaseTool):
    name: str = "GrepToolTool"
    description: str = "Description for GrepToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = GrepToolToolInput # Uncomment if Input Schema is defined
