...
# Example:
# class CutToolToolInput(BaseModel):
...
class CutToolTool(BaseTool):
    name: str = "CutToolTool"
    description: str = "Description for CutToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = CutToolToolInput # Uncomment if Input Schema is defined
