...
# Example:
# class ForemostToolToolInput(BaseModel):
...
class ForemostToolTool(BaseTool):
    name: str = "ForemostToolTool"
    description: str = "Description for ForemostToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = ForemostToolToolInput # Uncomment if Input Schema is defined
