...
# Example:
# class FtkImagerToolToolInput(BaseModel):
...
class FtkImagerToolTool(BaseTool):
    name: str = "FtkImagerToolTool"
    description: str = "Description for FtkImagerToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = FtkImagerToolToolInput # Uncomment if Input Schema is defined
