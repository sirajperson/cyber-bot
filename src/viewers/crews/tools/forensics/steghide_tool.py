...
# Example:
# class SteghideToolToolInput(BaseModel):
...
class SteghideToolTool(BaseTool):
    name: str = "SteghideToolTool"
    description: str = "Description for SteghideToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = SteghideToolToolInput # Uncomment if Input Schema is defined
