...
# Example:
# class VolatilityToolToolInput(BaseModel):
...
class VolatilityToolTool(BaseTool):
    name: str = "VolatilityToolTool"
    description: str = "Description for VolatilityToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = VolatilityToolToolInput # Uncomment if Input Schema is defined
