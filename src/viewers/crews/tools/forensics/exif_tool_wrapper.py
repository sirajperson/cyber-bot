...
# Example:
# class ExifToolWrapperToolInput(BaseModel):
...
class ExifToolWrapperTool(BaseTool):
    name: str = "ExifToolWrapperTool"
    description: str = "Description for ExifToolWrapperTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = ExifToolWrapperToolInput # Uncomment if Input Schema is defined
