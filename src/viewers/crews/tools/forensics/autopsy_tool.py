...
# Example:
# class AutopsyToolToolInput(BaseModel):
...
class AutopsyToolTool(BaseTool):
    name: str = "AutopsyToolTool"
    description: str = "Description for AutopsyToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = AutopsyToolToolInput # Uncomment if Input Schema is defined
