...
# Example:
# class JohnToolToolInput(BaseModel):
...
class JohnToolTool(BaseTool):
    name: str = "JohnToolTool"
    description: str = "Description for JohnToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = JohnToolToolInput # Uncomment if Input Schema is defined
