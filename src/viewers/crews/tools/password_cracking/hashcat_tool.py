...
# Example:
# class HashcatToolToolInput(BaseModel):
...
class HashcatToolTool(BaseTool):
    name: str = "HashcatToolTool"
    description: str = "Description for HashcatToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = HashcatToolToolInput # Uncomment if Input Schema is defined
