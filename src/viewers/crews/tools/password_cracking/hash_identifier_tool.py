...
# Example:
# class HashIdentifierToolToolInput(BaseModel):
...
class HashIdentifierToolTool(BaseTool):
    name: str = "HashIdentifierToolTool"
    description: str = "Description for HashIdentifierToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = HashIdentifierToolToolInput # Uncomment if Input Schema is defined
