...
# Example:
# class WiresharkFilterToolToolInput(BaseModel):
...
class WiresharkFilterToolTool(BaseTool):
    name: str = "WiresharkFilterToolTool"
    description: str = "Description for WiresharkFilterToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = WiresharkFilterToolToolInput # Uncomment if Input Schema is defined
