...
# Example:
# class TsharkToolToolInput(BaseModel):
...
class TsharkToolTool(BaseTool):
    name: str = "TsharkToolTool"
    description: str = "Description for TsharkToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = TsharkToolToolInput # Uncomment if Input Schema is defined
