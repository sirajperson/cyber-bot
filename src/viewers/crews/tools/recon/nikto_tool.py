...
# Example:
# class NiktoToolToolInput(BaseModel):
...
class NiktoToolTool(BaseTool):
    name: str = "NiktoToolTool"
    description: str = "Description for NiktoToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = NiktoToolToolInput # Uncomment if Input Schema is defined
