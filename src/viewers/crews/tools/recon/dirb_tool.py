...
# Example:
# class DirbToolToolInput(BaseModel):
...
class DirbToolTool(BaseTool):
    name: str = "DirbToolTool"
    description: str = "Description for DirbToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = DirbToolToolInput # Uncomment if Input Schema is defined
