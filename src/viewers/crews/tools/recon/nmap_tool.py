...
# Example:
# class NmapToolToolInput(BaseModel):
...
class NmapToolTool(BaseTool):
    name: str = "NmapToolTool"
    description: str = "Description for NmapToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = NmapToolToolInput # Uncomment if Input Schema is defined
