...
# Example:
# class NucleiToolToolInput(BaseModel):
...
class NucleiToolTool(BaseTool):
    name: str = "NucleiToolTool"
    description: str = "Description for NucleiToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = NucleiToolToolInput # Uncomment if Input Schema is defined
