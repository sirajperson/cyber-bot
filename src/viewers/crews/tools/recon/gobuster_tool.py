...
# Example:
# class GobusterToolToolInput(BaseModel):
...
class GobusterToolTool(BaseTool):
    name: str = "GobusterToolTool"
    description: str = "Description for GobusterToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = GobusterToolToolInput # Uncomment if Input Schema is defined
