...
# Example:
# class OpensslToolToolInput(BaseModel):
...
class OpensslToolTool(BaseTool):
    name: str = "OpensslToolTool"
    description: str = "Description for OpensslToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = OpensslToolToolInput # Uncomment if Input Schema is defined
