...
# Example:
# class SocialMediaSearchToolToolInput(BaseModel):
...
class SocialMediaSearchToolTool(BaseTool):
    name: str = "SocialMediaSearchToolTool"
    description: str = "Description for SocialMediaSearchToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = SocialMediaSearchToolToolInput # Uncomment if Input Schema is defined
...
if __name__ == "__main__":
    tool = SocialMediaSearchToolTool()
