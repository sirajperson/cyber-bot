...
# Example:
# class GithubSearchToolToolInput(BaseModel):
...
class GithubSearchToolTool(BaseTool):
    name: str = "GithubSearchToolTool"
    description: str = "Description for GithubSearchToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = GithubSearchToolToolInput # Uncomment if Input Schema is defined
