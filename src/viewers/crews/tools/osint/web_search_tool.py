...
# Example:
# class WebSearchToolToolInput(BaseModel):
...
class WebSearchToolTool(BaseTool):
    name: str = "WebSearchToolTool"
    description: str = "Description for WebSearchToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = WebSearchToolToolInput # Uncomment if Input Schema is defined
