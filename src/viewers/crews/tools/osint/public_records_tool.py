...
# Example:
# class PublicRecordsToolToolInput(BaseModel):
...
class PublicRecordsToolTool(BaseTool):
    name: str = "PublicRecordsToolTool"
    description: str = "Description for PublicRecordsToolTool. Explain what it does and when to use it."
    # args_schema: Type[BaseModel] = PublicRecordsToolToolInput # Uncomment if Input Schema is defined
